...
for f in fruits:
   print('The list of fruits -', f)
   
#2 method 
   
fruits = ["apple", "banana","kiwi","watermelon"]
last_item = len(fruits)
...
set([2, 3, 4, 5, 6, 7, 8]) - set([1, 2, 3, 4, 5])
{8,6,7}
# все остальные числа в этой линии будут повторяться 2, 3, 4, 5

# 2 method
import random
first_list = [random.range(0,10)]
second_list = [random.range(0,10)]
...
second_list = {'2', '3', '4', '5', '6', '7', '8'}
match_remove = second_list - first_list
print(list(match_remove))
# все повторяющие цифры отобразятся  2, 3, 4, 5
